...
describe('scope', () => {
  ...
  test('允许同范围 Pointer Drag and Drop 并拒绝跨范围放下', () => {
    ...
    sourceA.dispatchEvent(pointerEvent('pointermove', 7, 20, 20))
    expect(targetA.getAttribute('data-drop-acceptable')).toBe('true')
    sourceA.dispatchEvent(pointerEvent('pointerup', 7, 20, 20))
