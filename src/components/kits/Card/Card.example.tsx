  ...
  return (
    <Article as={Card} class="example-card">
      ...
      <div class="card-example-grid">
        <Card class="card-example-item" size="small">
          <strong>Small</strong>
          <span>紧凑信息单元</span>
        </Card>
        ...
        <Card class="card-example-item" size="large">
          <strong>Large</strong>
          <span>宽松信息单元</span>
        </Card>
        <Card class="card-example-item" size="xlarge">
          <strong>XLarge</strong>
          <span>大尺寸信息单元</span>
        </Card>
        <Card class="card-example-item" tone="soft">
          <strong>Soft</strong>
          <span>低声量辅助卡片</span>
        </Card>
        <Card class="card-example-item" tone="solid">
          <strong>Solid</strong>
          <span>稳定对比的实体卡片</span>
        </Card>
      </div>
