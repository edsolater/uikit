...
export function derive<T, U, R>(sources: [Source<T>, Source<U>], combiner: (a: T, b: U) => R): StateView<R>
...
export function derive<T, R>(sources: Source<T>[], combiner: (...args: T[]) => R): StateView<R>
