...
export default function SplitView({ lineProps, dir = 'x', ...props }: RowSplitProps) {
  ...
  useEffect(() => {
    const takeRestSpaceWindowItemIndex = refs.current
      ...
      .findIndex((i) => hasTag(i, takeSlipRestTag))
...
const takeSlipRestTag = createDataTag({ key: 'RowSplit', value: 'container-flexible' })
SplitView.takeSlipRestTag = takeSlipRestTag
